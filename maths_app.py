...
FOLDERS = {
    "June QP": "9709_June_qp", "Nov QP": "9709_Nov_qp",
    "June MS": "9709_June_ms", "Nov MS": "9709_Nov_ms"
}
...
# Session State for the "Basket" and Search results
    ...
    if st.button("Search Papers", type="primary"):
        if keywords:
            with st.spinner("Scanning all papers..."):
                st.session_state.search_results = search_pdfs([keywords], FOLDERS["June QP"]) + search_pdfs([keywords],
                                                                                                            FOLDERS[
                                                                                                                "Nov QP"])
        else:
